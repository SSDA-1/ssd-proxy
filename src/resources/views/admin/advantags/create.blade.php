...
@section('content')
    <div class="header-page">
        <div class="title-page">
            <h2>@lang('phrases.Создание нового преимущества')</h2>
        </div>
        <div class="buttons">
        ...
        <div class="block-background basement-form">
            <div class="row">
                <div class="field">
                    ...
                    <input type="text" placeholder="@lang('phrases.Название')" name="title" class="input-text">
                    <input type="text" placeholder="@lang('phrases.Порядок вывода')" name="position" value="1" hidden
                        class="input-text">
                </div>
                <div class="field">
            ...
            <div class="row">
                <div class="field">
                    ...
                    <input type="text" placeholder="@lang('phrases.Название')_en" name="title_en" class="input-text">
                </div>
            </div>
            <div class="row">
                <div class="field list">
...
@section('script')
    ...
    <script>
        $('#summernote').summernote({
            placeholder: '@lang('phrases.Полное описание')',
            tabsize: 2,
            height: 120,
            toolbar: [
                ['style', ['style']],
