<div class="modal">
    <div class="background">
        <div class="body bodyFirst">
            <div class="title">@lang('phrases.Вы точно хотите удалить это')?</div>
            ...
            <div class="footer-block">
                <form action="" method="POST" id="modalForm" class="">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-delite">@lang('phrases.Удалить')</button>
                </form>
                <form action="" method="POST" id="modalFormExport">
                    ...
                    <button type="submit" class="btn btn-delite"
                        style="background-color: #557dfc;">@lang('phrases.Импортировать')</button>
                </form>
            </div>
        </div>
        <style>
        ...
        <div class="body bodyEdit" style="display: none;">
            ...
            <form action="{{route('addTimeProxy')}}" method="POST" data-fetch="yes" id="modalFormEdit">
                ...
                <div class="mass block-background">
                    <div class="row">
                        <div class="field">
                            <div class="title-field">@lang('phrases.Количество Дней'):</div>
                    ...
                    <div class="row">
                        <div class="field">
                            <div class="title-field">@lang('phrases.Количество Времени'):</div>
                            <div class="wrap-input">
                ...
                <div class="footer-block">
                    <button type="submit" class="btn btn-delite" style="background-color: #557dfc;">@lang('phrases.Сохранить')</button>
                </div>
            </form>
        </div>
    </div>
