...
@section('content')
    <div class="header-page">
        <div class="title-page">
            <h2>@lang('phrases.Создание нового пункта меню')</h2>
        </div>
        <div class="buttons">
        ...
        <div class="block-background basement-form">
            <div class="row">
                <div class="field">
                    ...
                    <input type="text" placeholder="@lang('phrases.Название')" name="name" id="name" class="input-text">
                    <input type="text" placeholder="@lang('phrases.Название')_en" name="name_en" id="name_en" class="input-text">
