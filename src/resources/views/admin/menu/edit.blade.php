...
@section('content')
    <div class="header-page">
        <div class="title-page">
            <h2>@lang('proxies::phrases.Редактирование пункта меню'): {{ $menu->name }}</h2>
        </div>
        <div class="buttons">
        ...
        <div class="block-background basement-form">
            <div class="row">
                <div class="field">
                    ...
                    <input type="text" placeholder="@lang('proxies::phrases.Название')"
                    ...
                    <input type="text" placeholder="@lang('proxies::phrases.Название')_en"
                    ...
                    <select id="socName" @if ($menu->type_menu == 3) name="name" @else style="display:none;" @endif
                        ...
                        @if ($menu->name == 'vk')
                            <option value="vk" selected>@lang('proxies::phrases.ВКонтакте')</option>
                        @else
                        ...
                        @if ($menu->name == 'telegram')
                            <option value="telegram" selected>@lang('proxies::phrases.Телеграм')</option>
                        @else
                ...
                <div class="field">
                    ...
                    <select name="type_menu" id="type_menu" value="{{ $menu->type_menu }}" class="select-multiple">
                        ...
                        @if ($menu->type_menu == 3)
                            <option value="3" selected>@lang('proxies::phrases.Социальные сети')</option>
                        @else
