...
@section('content')
    <div class="header-page">
        <div class="title-page">
            <h2>@lang('phrases.Редактирование новости') {{ $news->name }}</h2>
        </div>
        <div class="buttons">
        ...
        <div class="block-background basement-form">
            <div class="row">
                <div class="field">
                    ...
                    <input type="text" name="name" value="{{ $news->name }}" class="input-text" placeholder="@lang('phrases.Имя')">
                </div>
            </div>
            <div class="row">
                <div class="field">
            ...
            <div class="row">
                <div class="field">
                    ...
                    <input type="text" name="name_en" value="{{ $news->name_en }}" class="input-text" placeholder="@lang('phrases.Имя')">
                </div>
            </div>
            <div class="row">
                <div class="field list">
