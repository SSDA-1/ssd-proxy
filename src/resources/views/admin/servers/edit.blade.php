...
@section('content')
    <div class="header-page">
        <div class="title-page">
            <h2>@lang('phrases.Редактирование сервера') "{{ $server->name }}"</h2>
        </div>
        <div class="buttons">
    ...
    <div class="block-background basement-form">
        <div class="row">
            <div class="field">
                ...
                {!! Form::text('name', null, ['placeholder' => trans('phrases.Сервер') . ' №1', 'class' => 'input-text']) !!}
            </div>
        ...
        <div class="row">
            <div class="field">
                <div class="title-field">HTTP (@lang('phrases.Мин').):</div>
            ...
            <div class="field">
                <div class="title-field">HTTP (@lang('phrases.Макс').):</div>
            ...
            <div class="field">
                <div class="title-field">SOCKS (@lang('phrases.Мин').):</div>
            ...
            <div class="field">
                <div class="title-field">SOCS (@lang('phrases.Макс').):</div>
