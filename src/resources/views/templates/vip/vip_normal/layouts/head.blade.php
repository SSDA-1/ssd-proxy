<!-- Меню настолка -->
<div class="data-demo">
    <div class="info">Это деманстрационная версия программы SEASIDE Proxy, предназначеная исключительно для ознакомления: <br> Логин и пароль от панели администратора Demo@ssdigital.ru Demo123</div>
    <div class="pay-info">Вы можете в любой момент оформать подписку на программу SEASIDE Proxy на сайте <a href="http://ssd-p.ru">http://ssd-p.ru</a></div>
</div> 
