...
// Маршрут для проверки статуса обновления (без аутентификации для доступа из AJAX)
Route::get('/update-status', 'Ssda1\proxies\Http\Controllers\UpdateController@checkUpdateStatus')
    ->name('update-status')
